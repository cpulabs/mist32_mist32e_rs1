...
TOP_LEVEL_NAME="altera_asmi_rom"
QSYS_SIMDIR="./../"
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_asmi_rom_asmi_parallel_0.v" -work asmi_parallel_0 -cdslib ./cds_libs/asmi_parallel_0.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_asmi_rom.v"                                                                                            
fi
